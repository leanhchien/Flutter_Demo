    ...
    return interestSumaryDatas.map((sumary) {
      var container = Container(
        decoration: new BoxDecoration(
            color: Colors.grey, border: Border(bottom: BorderSide())),
        child: new Row(
          children: <Widget>[
            new Container(
              width: width1,
              ...
              child: new Text(
                sumary.typeMoney + "  " + sumary.typeBidAsk,
                style: TextStyle(
                    color: Colors.white,
            ...
            new Column(
              ...
              children: <Widget>[
                new Container(
                  ...
                  child: new Text(sumary.interestQuantity,
                      style: TextStyle(
                          color: Colors.white,
                          fontWeight: FontWeight.bold,
                          fontSize: 14.0)),
                ...
                new Container(
                  width: width2,
                  padding: const EdgeInsets.only(top: 8.0, bottom: 8.0),
                  child: new Text(sumary.underCover,
                      style: TextStyle(
                          color: Colors.white,
                          fontWeight: FontWeight.bold,
                          fontSize: 14.0)),
            ...
            new Column(
              ...
              children: <Widget>[
                ...
                new Container(
                  width: width2,
                  padding: const EdgeInsets.only(top: 8.0, bottom: 8.0),
                  child: new Text(sumary.evaluationRate,
                      style: TextStyle(
                          color: Colors.white,
                          fontWeight: FontWeight.bold,
                          fontSize: 14.0)),
            ...
            new Column(
              ...
              children: <Widget>[
                new Container(
                  padding: const EdgeInsets.only(top: 8.0, bottom: 8.0),
                  child: new Text(sumary.valuation,
                      style: TextStyle(
                          color: Colors.white,
                          fontWeight: FontWeight.bold,
                          fontSize: 14.0)),
